...
│   └── plugins/
│       ├── agent-toolkit.ts        # plugin entrypoint + 도구 21 개 (notion 4 + swagger 5 + journal 4 + mysql 5 + spec-pact 1 + spec-to-issues 2)
...
plugin 이 opencode 에 다음 21 개를 등록한다.
