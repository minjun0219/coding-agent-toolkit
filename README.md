...
| OpenAPI 캐시 (`swagger_*`, 5 개) | OpenAPI / Swagger JSON spec 캐시 + endpoint 검색 + `host:env:spec` 핸들 | [FEATURES.md#openapi-cache-swagger_](./FEATURES.md#openapi-cache-swagger_) |
